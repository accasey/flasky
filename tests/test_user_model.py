...
class UserModelTestCase(unittest.TestCase):
    ...
    def test_invalid_confirmation_token(self):
        u1: User = User(password="cat")
        u2: User = User(password="dog")
        db.session.add(u1)
        db.session.add(u2)
        db.session.commit()
    ...
    def test_expired_confirmation_token(self):
        ...
        db.session.add(u)
        db.session.commit()
        token: str = u.generate_confirmation_token(1)
        time.sleep(2)
    ...
    def test_gravatar(self):
        ...
        self.assertTrue(
            "gravatar.com/avatar/d4c74594d841139328695756648b6bd6" in gravatar
        )
